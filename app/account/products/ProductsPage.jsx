...
const ProductsPage = () => {
  const [accordionState, setAccordionState] = useState({}); // Keeps track of open accordions
  ...
  return (
    <section className="pt-24 pb-36 overflow-hidden">
      <div className="container mx-auto px-4">
        <h2 className="mb-6 font-heading font-semibold text-3xl sm:text-4xl text-gray-900">
          Purchase Products
        </h2>
            ...
            <div className="w-full">
              {data.map((row, index) => (
                <div key={index}>
                  ...
                  >
                    <div className="py-3.5 px-5 bg-white shadow-lg">
