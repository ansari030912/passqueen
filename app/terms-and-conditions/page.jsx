          ...
          <div className="flex flex-wrap lg:items-center -mx-4">
            <div className="w-full md:w-12/12 px-4">
              <h2 className="mb-4 text-2xl md:text-3xl  leading-tight bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 font-bold tracking-tighter">
                Important Information Regarding PassQueen.com Terms And
                Conditions
              </h2>
          ...
          <div className="flex flex-wrap -mx-4">
            <div className="w-full md:flex-1 px-4">
              <p className="mb-4 text-lg font-base text-gray-500">
                PassQueen.com (referred to as the &quot;Company&quot;,
                &quot;we&quot;, &quot;us&quot;, &quot;our&quot;) operates the
                website https://passqueen.com, including all subsidiary pages
              ...
              <p className="mb-4 text-base md:text-lg font-medium text-gray-500">
                ...
                For any inquiries, please contact us at sales@passqueen.com.
              </p>
            </div>
          </div>
        </div>
...
export async function generateMetadata() {
  return {
    title: `PassQueen Terms & Conditions`,
    ...
    alternates: {
      canonical: "https://passqueen.com/terms-and-conditions",
    },
  };
}
