    ...
    <>
      ...
      <section class="pt-20 bg-white">
        <div class="container mx-auto px-4">
          <div class="pb-20 border-b border-gray-50 mb-4">
            <div class="flex flex-wrap -m-4">
              <div class="w-full lg:w-1/2 p-4">
                ...
                <p class="text-gray-500">
                  ...
                  Similarly, PassQueen does not supply real Amazon exam
                  questions. The materials offered by PassQueen lack real
                  questions and answers of certification exams. The CFA
                  Institute neither endorses nor assures the accuracy or quality
                  of PassQueen content. CFA® and Chartered Financial Analyst®
                  are registered trademarks held by the CFA Institute.
                </p>
              </div>
          ...
          <div class="flex flex-wrap -m-4">
            ...
            {/* <div class="w-full md:w-1/3 p-4">
              <div class="flex md:justify-end flex-wrap gap-6">
                <a
                  href="#"
                  class="text-gray-900 hover:text-opacity-80 transition duration-200"
                >
                  <svg
