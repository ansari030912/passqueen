    ...
    <section className="pb-6 pl-4 pt-12 mb-6">
      <div className="container mx-auto px-4">
        <Grid
          ...
          className=" rounded-3xl shadow-lg bg-white pb-10"
        >
            ...
            <div className="p-6 w-full">
              <div className="">
                <div className="lg:flex justify-between">
                  <div className="inline-block text-xl text-stone-500 font-black">
                    {examData?.exam_vendor_title}
                  </div>
                  <div className="text-gray-600 font-black bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500">
                    {examData?.exam_code}
                  </div>
                </div>
